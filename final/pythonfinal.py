...
class the_draft: #this is where all the drafting of players happens
    def __init__(self, master):
        ...
        self.player_entry.bind('<BackSpace>', self.edit_search) #instead of adding backspace to the search actually backspace
    ...
    def entry_insert(self, master): # removes any characters from the entry box then adds the selected player to entry box
